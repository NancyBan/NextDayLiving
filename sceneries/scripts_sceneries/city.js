...
const yes = document.getElementById('trashBag'); //Variable para en caso de que el usuario pulse si
...
const no = document.getElementById('trashBag'); //Variable para en caso de que el usuario pulse no
